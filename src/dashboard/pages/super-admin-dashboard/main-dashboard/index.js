...
const cardClassName =
  "col-sm-3 d-flex row rounded-1 shadow bg-white p-4 justify-content-center";
      ...
      <div className="d-flex row m-4 justify-content-around">
        ...
        <div className={cardClassName}>
          ...
          <h2 className={contentClassName}>
            2463
            <HiOutlineArrowNarrowUp
              style={{ color: "green", fontSize: "1.1em" }}
            />
          </h2>
          <PrimaryButton
            label="show details"
        ...
        <div className="col-sm-5 d-flex row rounded-1 shadow bg-white p-4 me-5 justify-content-center">
          ...
          <div className="col-sm-12 mb-lg-0 mb-sm-3">
            ...
            <div className="row justify-content-between align-items-center py-2">
              ...
              <div className="col-7">
                <h6>
                  <a href="#">kamren76</a> sent a <a href="#">live stream</a>{" "}
                  support <a href="#">request</a>
                </h6>
              </div>

              <div className="col-4 text-end text-secondary">
                <h6 className="font-weight-bolder">
                  <span className="badge bg-dark">NEW</span> today
                </h6>
                <h6>26.08.2024</h6>
              </div>
            </div>
            ...
            <div className="row justify-content-between align-items-center py-2">
              ...
              <div className="col-7">
                <h6>
                  <a href="#">kim.hermann</a> sent a <a href="#">live stream</a>{" "}
                  support <a href="#">request</a>
                </h6>
              </div>
            ...
            <div className="row justify-content-between align-items-center py-2">
              ...
              <div className="col-7">
                <h6>
                  <a href="#">wendy.stark</a> sent a <a href="#">live stream</a>{" "}
                  support <a href="#">request</a>
                </h6>
              </div>
            ...
            <div className="row justify-content-between align-items-center py-2">
              ...
              <div className="col-7">
                <h6>
                  <a href="#">gutmann.brown</a> sent a{" "}
                  <a href="#">live stream</a> support <a href="#">request</a>
                </h6>
              </div>
            ...
            <div className="row justify-content-between align-items-center py-2">
              ...
              <div className="col-7">
                <h6>
                  <a href="#">rigoberto.braun</a> sent a{" "}
                  <a href="#">live stream</a> support <a href="#">request</a>
                </h6>
              </div>
            ...
            <div className="row justify-content-between align-items-center py-2">
              ...
              <div className="col-7">
                <h6>
                  <a href="#">shaniya.hagenes</a> sent a{" "}
                  <a href="#">live stream</a> support <a href="#">request</a>
                </h6>
              </div>
            ...
            <div className="row justify-content-between align-items-center py-2">
              ...
              <div className="col-7">
                <h6>
                  <a href="#">hsimonis</a> sent a <a href="#">live stream</a>{" "}
                  support <a href="#">request</a>
                </h6>
              </div>
