...
import { RiVideoUploadLine, RiCheckboxCircleLine, RiEmotionHappyLine, RiShoppingCart2Line } from "react-icons/ri";
import { TbShoppingCart, TbCurrencyDollar, TbHeart, TbPlayerPlay } from "react-icons/tb";
              ...
              <div className="row">
                <div className="col-8">
                  <div className="numbers">
                    <p className="text-sm mb-0 text-capitalize text-secondary font-weight-bold">Streams Uploaded</p>
                ...
                <div className="col-4 text-end d-flex justify-content-end">
                  <div className="icon icon-shape bg-dark shadow text-center border-radius-md">
                    <RiVideoUploadLine style={{ fontSize: "38px", margin: "5px" }} />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="card">
            <div className="card-body p-3">
              <div className="row">
                <div className="col-8">
                  <div className="numbers">
                    <p className="text-sm mb-0 text-capitalize text-secondary font-weight-bold">Streams Approved</p>
                    <h5 className="font-weight-bolder mb-0">
                      954
                ...
                <div className="col-4 text-end d-flex justify-content-end">
                  <div className="icon icon-shape bg-dark shadow text-center border-radius-md">
                    <RiCheckboxCircleLine style={{ fontSize: "38px", margin: "5px" }} />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="card">
            <div className="card-body p-3">
              <div className="row">
                <div className="col-8">
                  <div className="numbers">
                    <p className="text-sm mb-0 text-capitalize text-secondary font-weight-bold">Interest Rate</p>
                    <h5 className="font-weight-bolder mb-0">
                      80%
                      <span className="text-success text-sm font-weight-bolder ps-2">out of 1,453</span>
                    </h5>
                  </div>
                </div>
                <div className="col-4 text-end d-flex justify-content-end">
                  <div className="icon icon-shape bg-dark shadow text-center border-radius-md">
                    <RiEmotionHappyLine style={{ fontSize: "38px", margin: "5px" }} />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="card">
            <div className="card-body p-3">
              <div className="row">
                <div className="col-8">
                  <div className="numbers">
                    <p className="text-sm mb-0 text-capitalize text-secondary font-weight-bold">Items</p>
                    <h5 className="font-weight-bolder mb-0">
                      934
                      <span className="text-success text-sm font-weight-bolder ps-2">+10%</span>
                    </h5>
                  </div>
                </div>
                <div className="col-4 text-end d-flex justify-content-end">
                  <div className="icon icon-shape bg-dark shadow text-center border-radius-md">
                    <RiShoppingCart2Line style={{ fontSize: "38px", margin: "5px" }} />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card-body">
              <div className="row">
                <div className="col-sm-7">
                  <p className="text-secondary font-weight-bolder">Article of the Day</p>
                  <h5 className="font-weight-bolder">How to improve interest rate of Streams</h5>
                  <p className="text-secondary">Learn some tips that will help you understand the metrics which directly impact the interest rate of your videos.</p>
                ...
                <div className="col-sm-5 d-flex align-items-center justify-content-center">
                  <FaRegNewspaper className="rounded-4 bg-dark px-3" style={{ color: 'white', fontSize: "182px" }} />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card">
            <div className="card-body">
              <div className="bg-dark rounded p-3 text-white">
                <h3 className="font-weight-bolder">Work with the best Creators</h3>
                <p>Looking for collaborators? Explore like minded people who are willing to collaborate with you in your streams and take your content to new heights.</p>
                <a className="d-inline-flex mt-5" href="#">
          ...
          <div className="card">
            <div className="card-body">
              ...
              <div className="py-3">
                ...
                <p className="text-secondary"><span className="font-weight-bolder">(+23%)</span> more than last month</p>
                ...
                <div className="row">
                  ...
                  <div className="col-3">
                    ...
                    <div style={{ width: '100%', height: '10px' }} className="rounded bg-secondary">
                      <div style={{ width: '80%', height: '10px' }} className="rounded bg-dark"></div>
                    </div>
                  ...
                  <div className="col-3">
                    ...
                    <div style={{ width: '100%', height: '10px' }} className="rounded bg-secondary">
                      <div style={{ width: '35%', height: '10px' }} className="rounded bg-dark"></div>
                    </div>
                  ...
                  <div className="col-3">
                    ...
                    <div style={{ width: '100%', height: '10px' }} className="rounded bg-secondary">
                      <div style={{ width: '60%', height: '10px' }} className="rounded bg-dark"></div>
                    </div>
                  ...
                  <div className="col-3">
                    ...
                    <div style={{ width: '100%', height: '10px' }} className="rounded bg-secondary">
                      <div style={{ width: '50%', height: '10px' }} className="rounded bg-dark"></div>
                    </div>
          ...
          <div className="card">
            <div className="card-body py-4">
              ...
              <p className="d-flex text-secondary pb-4">
                <FaArrowUp style={{fontSize: '18px', color: 'green', marginRight: '10px'}} />
