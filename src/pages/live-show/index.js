...
export default function LiveShow() {
  ...
  const Sidebar = () => {
    ...
    const buttonClass = "list-group-item mb-4 mx-3 px-4 py-4 rounded-pill list-group-item-action"

    return (
      <div className="col-md-3 my-5 px-2 list-group">
        <h2 className="text-white mx-4 mb-4 align-self-center">Categories</h2>
        <Stack spacing={4} direction={isDesktop ? "column" : "row"} align='center'>
          <PrimaryButton colorScheme="purple" btnStyle={{borderRadius: 25, width: "20vw" }} background="null" size='lg' variant="solid" label="All" />
          <PrimaryButton colorScheme="purple" btnStyle={{borderRadius: 25, width: "20vw" }} background="null" size='lg' variant="outline" leftIcon={isDesktop ? <GiHealthNormal />: null} label="Health" />
          <PrimaryButton colorScheme="purple" btnStyle={{borderRadius: 25, width: "20vw" }} background="null" size='lg' variant="outline" leftIcon={isDesktop ? <FaUserGraduate />: null} label="Edu" />
          <PrimaryButton colorScheme="purple" btnStyle={{borderRadius: 25, width: "20vw" }} background="null" size='lg' variant="outline" leftIcon={isDesktop ? <GrTechnology />: null} label="Tech" />
          <PrimaryButton colorScheme="purple" btnStyle={{borderRadius: 25, width: "20vw" }} background="null" size='lg' variant="outline" leftIcon={isDesktop ? <FaCloudSun />: null} label="Climate" />
          <PrimaryButton colorScheme="purple" btnStyle={{borderRadius: 25, width: "20vw" }} background="null" size='lg' variant="outline" leftIcon={isDesktop ? <MdOutlineWork />: null} label="Career" />
        </Stack>
      </div>
    ...
    return (
      <div className="col-md-9">
        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            ...
            <div className="carousel-caption">
              ...
              <p style={{fontSize: 'calc(0.8em + 1.5vw)'}}>Watch live how the top teams.</p>
              <p style={{fontSize: 'calc(0.8em + 1.5vw)'}}>play FaZe Clan VS Mousesports</p>
        ...
        <div className="row p-0 mx-0 my-2 d-flex justify-content-between align-items-center">
          <h1 className="col-6 text-white">Live Shows</h1>
          <div className="custom-select col-2">
  ...
  return <Layout>
    <div className="row position-relative d-flex w-100 mt-5 pt-5">
      <Sidebar />
      <MainContent />
    </div>
  </Layout>;
