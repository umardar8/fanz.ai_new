        ...
        <div className="px-5 lg:max-w-7xl mx-auto">
          <div className="grid grid-cols-12 items-center">
            <div className="col-span-12">
              <h2 className="text-[20px] md:text-[25px] lg:text-[28px] xl:text-[36px] font-bold font-sans leading-[35px] sm:leading-[45px] text-center text-white mb-3">
                Let’s Read What Our Clients Have to Say
              </h2>
              <p className="text-[13px] lg:text-[16px] leading-[21px] font-sans text-center text-white mx-auto mb-10">
                If you can’t trust us, try trusting them.
              </p>
            </div>
            <div className="col-span-4 xl:col-span-5 hidden md:block">
              <Image
                src={ClientImage}
                alt="Clients"
                className="mt-[-57px] lg:mt-0 lg:mb-[-70px] lg:block hidden"
              />
            </div>
            <div className="col-span-12 xl:col-span-7">
              <Slider
                {...ClientSlider}
                className="clientSlider lg:w-[62%] xl:w-[50%] bottom-[7%] right-0 mt-[25px] lg:mt-0 md:bottom-[33%] lg:bottom-[29%]"
              >
                {testiContentNew2.map((testimonial, index) => (
                  ...
                  >
                    <div
                      className="flex justify-center items-center slide px-4 lg:pe-8 my-auto"
                      ...
                      {testimonial.video ? (
                        ...
                        <div className="w-[100px] sm:w-[150px] h-[155px] md:h-[184px] box-testi ">
                          <div className="w-[100px] sm:w-[150px] h-[150px]  md:h-[180px] flex justify-center items-center  overlay-div-testi">
                            ...
                            />
                            <div className="overlay-testi rounded-[12px] w-[100px] sm:w-[150px] h-ful"></div>
                          </div>
                        </div>
                      )}
                      <div className="pe-[15px] ">
                        <div className="client ms-[15px]">
                          <h3 className="text-[20px] text-white font-bold font-sans">
                            {testimonial.name}
                          </h3>
