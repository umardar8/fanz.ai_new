  ...
  return (
    ...
    >
      ...
      <div className="d-flex row col-2 p-0 m-0">
        <img src={icon} alt="weather icon" height="3rem" width="3rem" />
        <div className="text-size-2 d-flex fw-bolder">{temp} °F</div>
      </div>
      ...
      <div className="col-4">
        <div className="fw-bolder text-size-1 text-end pb-2">{time}</div>
        <div
